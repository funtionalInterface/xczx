    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                ...
                <a href="#"  @click="addopenmodel.course" v-if="learnstatus == 2" v-cloak>立即报名</a>
		...
		高级
                ...
                <span><em>课程时长</em><stat v-text="model.course_stat.s601001"></stat>
                </span>
                <span><em>评分</em><stat v-text="model.course_stat.s601002"></stat></span>
                <span><em>授课模式</em>
	    ...
	    <#if (model.coursePic.pic)??>
		 ...
		 <p><img src="/static/img/widget-video.png" alt="" width="270" height="156"> </p>
            ...
            <p class="vid-act"><span> <i class="i-heart"></i>收藏 <stat v-text="model.course_stat.s601003"></stat> </span> <span>分享 <i class="i-weixin"></i><i class="i-qq"></i></span></p>
        </div>
    </div>
</div>
            ...
            <div class="article-cont">
                <div class="article-left-box">
                    <div class="content">
                        ...
                        <div class="content-com model.course">
            ...
            <div class="article-cont-ask">
                ...
                <div class="article-right-box">
                    <div class="about-teach">
                        ...
                        <div class="teach-info">
                            <p><a href="#" class="model.courselist_link">TA的课程</a></p>
                        </div>
            ...
            <div class="article-cont">
                <div class="article-left-box">
                    <div class="comment-box">
                        ...
                        <div class="model.course-evaluate">
...
<div class="popup-box" style="display: none">
    <div class="mask"></div>
    <!--欢迎访问课程弹窗- start -->
  <!--  <div class="popup-model.course-box">
...
<script>var model.courseId = "${model.courseBase.id}"</script>
<!--#include virtual="/include/model.course_detail_dynamic.html"-->
</body>
</html>