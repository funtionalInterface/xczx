package com.xuecheng.manage_media_process.mq.impl;
...
import com.xuecheng.manage_media_process.mq.MediaProcessTask;
...
@Component
public class MediaProcessTaskImpl implements MediaProcessTask {
    // 日志对象
    private static final Logger LOGGER = LoggerFactory.getLogger(MediaProcessTaskImpl.class);
    ...
    public void receiveMediaProcessTask(String msg) {
        ...
        try {
            ...
            e.printStackTrace();
            ExceptionCast.cast(MediaCode.MEDIA_PROCESS_FAIL);
        }
