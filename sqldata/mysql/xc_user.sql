...
INSERT INTO `xc_menu` VALUES ('11111111111111111111', 'xc_teachmanager_course_plan_media_delete', '903459378655395841', '删除课程的选择视频', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('222222222222222222', 'xc_teachmanager', '000000000000000000', '教学管理', NULL, '1', 1, 2, '1', NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('2222222222222222222', 'xc_teachmanager_course_plan_delete', '903459378655395841', '删除课程计划', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('3333333333333333333333', 'xc_teachmanager_course_plan_add', '903459378655395841', '添加课程计划', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('66666666666666667', 'xc_teachmanager_course_pic_add', '903459378655395841', '添加课程图片', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('66666666666666668', 'xc_teachmanager_course_pic_delete', '903459378655395841', '删除课程图片', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `xc_menu` VALUES ('903459378655395845', 'xc_teachmanager_coursemarket_edit', '903459378655395841', '编辑课程营销信息', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('903459378655395846', 'xc_teachmanager_course_base_edit', '903459378655395841', '编辑课程基础信息', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `xc_menu` VALUES ('903459378655395847', 'xc_teachmanager_course_plan_edit', '903459378655395841', '编辑课程计划', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `xc_menu` VALUES ('903459378655395851', 'xc_manager_meida_all', '903459378655395841', '视频文件操作', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `xc_permission`  (
  ...
  CONSTRAINT `fk_xc_permission_menu_id` FOREIGN KEY (`menu_id`) REFERENCES `xc_menu` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_xc_permission_role_id` FOREIGN KEY (`role_id`) REFERENCES `xc_role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `xc_user_role`  (
  ...
  CONSTRAINT `fk_xc_user_role_role_id` FOREIGN KEY (`role_id`) REFERENCES `xc_role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_xc_user_role_user_id` FOREIGN KEY (`user_id`) REFERENCES `xc_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
